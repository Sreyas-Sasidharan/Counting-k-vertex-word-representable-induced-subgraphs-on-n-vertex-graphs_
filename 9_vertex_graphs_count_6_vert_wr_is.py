...
G20 = Graph( [(1,2), (1,3), (1,4), (1,5), (1,6), (2,3), (3,4), (4,5), (5,6), (6,2), (2,4), (1,7), (3,7), (5,7), (6,7)])
...
for G in all_9_vertex_graphs_to_be_tested:
    is_bad = True  #indicates that the 9-vertex graph G under consideration has no word-representable 6-vertex I.S.
...
#Every 9-vertex graph have at least min(wr_subgraphs_6_vertex_count_list) number of 6-vertex word-representable induced subgraphs.